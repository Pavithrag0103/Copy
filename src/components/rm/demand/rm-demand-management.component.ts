...
export class RmDemandManagementComponent {
  ...
  readonly btnTabAddRequestRegion: Locator;
  readonly btnTabSave: Locator;
  readonly btnTabCarryDemandForward: Locator;
  readonly btnTabSubmitResourceRequest: Locator;
  ...
  constructor(page: Page) {
    ...
    this.btnTabAddRequestRegion= page.locator('button[id^="Add_Region_"]');
    this.btnTabSave= page.locator('button[id^="SAVE_"]');
    this.btnTabCarryDemandForward= page.locator('button[id^="Carry_"]');
    this.btnTabSubmitResourceRequest= page.locator('button[id^="Submit_"]');
  }
}