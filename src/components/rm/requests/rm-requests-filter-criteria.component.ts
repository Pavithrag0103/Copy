...
export class RmRequestsFilterCriteriaComponent {
  ...
  constructor(page: Page) {
    ...
    //Request Summary Report
    this.tableReport = page.locator('#Request_Report_Grid_ig_grid_vc > div.a-GV-bdy > div.a-GV-w-scroll > table.a-GV-table');
    //#Request_Report_Grid_ig_grid_vc > div.a-GV-bdy > div.a-GV-w-scroll > table > tbody > tr.a-GV-row.is-selected
  }
}