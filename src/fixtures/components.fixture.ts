...
import { RmProfileCriteriaComponent } from "@components/rm/requests/rm-profile-criteria.component";
...
export const componentFixture = base.extend<{
  ...
  rmProfileCriteriaComponent: RmProfileCriteriaComponent;
  ...
  rmProfileCriteriaComponent: async ({ page }, use) => {
    const rmProfileCriteriaComponent = new RmProfileCriteriaComponent(page);
    await use(rmProfileCriteriaComponent);
  },
