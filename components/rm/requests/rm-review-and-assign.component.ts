...
export class RmReviewAndAssignComponent {
  ...
  constructor(page: Page) {
    ...
    this.dropRegion = page.locator('#P30_RPF_REGION');
    this.dropCountry = page.locator('#P30_RPF_COUNTRY');
    this.dropRole = page.locator('#P30_RPF_ROLE');
    this.btnSearch = page.locator('#B10923652483018534228', { hasText: 'SEARCH' });
    this.dropDepartment = page.locator('#P30_RPF_DEPARTMENT');
    this.dropResourceName = page.locator('#P30_RPF_RESOURCE');
    this.dropSponsorExperience = page.locator('#P30_RPF_SPONSOR');
    this.dropEmployeeClass = page.locator('#P30_RPF_EMP_CLASS');
    this.dropState = page.locator('#P30_RPF_EMP_STATE');
    this.txtTenure = page.locator('#P30_RPF_TENURE');
    //Experience Criteria
    ...
    this.dropTherapeuticArea = page.locator('#P30_THERAPEUTIC_AREA_EC');
    this.dropTreatment = page.locator('#P30_TREATMENT_EC');
    this.dropStudyPhase = page.locator('#P30_STUDY_PHASE_EC');
    this.dropStudyPopulation = page.locator('#P30_STUDY_POPULATION_EC');
    this.dropTechnical = page.locator('#P30_TECHNICAL_EC');
    this.dropLanguage = page.locator('#P30_LANGUAGE_EC');
    //Request Details
    ...
    this.btnRDUndo = page.locator('#B10925906355579464328 > span.fa-undo-arrow').first();
    this.btnRDReset = page.locator('#B10925906355579464328 > span.t-Button-label');
    this.dropRequestDuration = page.locator('#P30_YEAR');
